...
This function will produce 2 tables. Select the **first** table in the list from each result set, then combine these results into a single table with the different sites delineated in the `site` column.
